subroutine WriteWakeElemData()
    ...
    do wcount=1,NWakeInd+nb
        do tCount=1,tCountMax
            ...
            write(12,'(E14.7,",",$)') TimeN                ! Normalized simulation time (t*Uinf/Rmax)
            write(12,'(I0,",",$)') node_id                 ! Unique node ID
            write(12,'(I0,",",$)') wcount                  ! Node number that wake element originated from
            write(12,'(E14.7,",",$)') X(tCount,wcount)     ! Wake element X position
            write(12,'(E14.7,",",$)') Y(tCount,wcount)     ! Wake element Y position
            write(12,'(E14.7,",",$)') Z(tCount,wcount)     ! Wake element Z position
            write(12,'(E14.7,",",$)') U(tCount,wcount)     ! Wake element X velocity
            write(12,'(E14.7,",",$)') V(tCount,wcount)     ! Wake element Y velocity
            ! Dont suppress carriage return on last column
            write(12,'(E14.7)') W(tCount,wcount)           ! Wake element Z velocity
        end do
    end do
