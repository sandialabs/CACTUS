SUBROUTINE AeroCoeffs(nElem,alpha75,alpha5,alpha,Re75,Re5,Re,wPNorm,adotnorm,umach,SectInd,IsBE,CL,CD,CN,CT,CLCirc,CM25) 
        ...
        real :: CLstat75, CLstat5, CDstat5, CLdyn5, CDdyn5, dCLAD, dCTAM, dCNAM, CL5, CD5, C, CMstat25, CM25
        real :: alphaL, alphaD, ReL, ReD, aref, Fac
        
        
        ! Calc static characteristics
        CALL intp(Re75,alpha75*condeg,CLstat75,C,SectInd) 
        CALL intp(Re5,alpha5*condeg,CLstat5,C,SectInd)
        CALL intp(Re5,alpha5*condeg,C,CDstat5,SectInd) 
        CMstat25=0.0  ! Could replace this with user defined Cm vs. alpha25 (about the quarter chord)
        
        ! Apply pitch rate effects by analogy to pitching flat plate potential flow theory 
        ! (SAND81-7017) 
        CL5=CLstat75
        CD5=CDstat5
        CM25=CMstat25+cos(alpha5)*(CLstat75-CLstat5)/4.0
        alphaL=alpha75
        alphaD=alpha5
        ReL=Re75
        ReD=Re5
        ...
        ! (SAND81-7017) 
        dCTAM=2.0/cos(alpha5)*wPNorm*CMstat25-CLstat5/2.0*wPNorm
