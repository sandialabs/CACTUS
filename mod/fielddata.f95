module fielddata
    ...
    ! module to initialize and store field velocity data for output
    ! used by WriteFieldData.f95

    integer :: FieldOutFlag
...
contains
    ...
    subroutine fielddata_cns()

        ! allocate location and velocity arrays
