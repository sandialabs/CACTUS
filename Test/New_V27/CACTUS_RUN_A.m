...
save('CACTUS_OUT_UWAKE_Long','DATA_ALL')

% LARGE FILES
save('CACTUS_OUT_ELEM_CLEAN_UWAKE_Long','DATA_ELEMENT','-v7.3') 

save('CACTUS_OUT_UWAKE_Long','DATA_WAKE')


save('CACTUS_OUT_WAKE_EL_CLEAN_UWAKE_Long','DATA_WAKE_EL')
